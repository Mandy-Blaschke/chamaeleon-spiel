export const WORDS: string[] = [
  ...
  'feige', 'hase', 'obst', 'heidelbeere', 'karotte', 'kartoffel', 'laufen', 'sprint', 'fußball', 'haus', 'garten',
  ...
  'kette', 'freundin', 'enkel', 'enkelin', 'sohn', 'tochter', 'test', 'bitte', 'betrachten', 'informationen', 'wetter', 'heiß',
  'hundert', 'küche', 'aufregung', 'euphorie', 'fragen', 'wissen', 'ernährung', 'vergangenheit', 'politik', 'superman',
  ...
  'jahreszeit', 'frühling', 'summe', 'verfügung', 'brille', 'schaufenster', 'pandemie', 'epidemie', 'irren', 'schlüssel',
  'schüssel', 'schlüsselbein', 'knochen', 'brechen', 'leute', 'taille', 'verstecken', 'höhle', 'sorgfalt', 'naschen',
  'spaß', 'perfekt', 'pronomen', 'personen', 'begrüßung', 'verabschiedung', 'sicherheit', 'sponsoren', 'seriös', 'reiz',
  ...
  'decke', 'beton', 'reihenhaus', 'photosynthese', 'wurm', 'poker', 'witze', 'ansteckend', 'brautkleid', 'duschen', 'erschrocken',
  'facebook', 'bruder', 'gänsehaut', 'schwester', 'sideboard', 'kommode', 'schulzeit', 'schreibblock', 'notizbuch', 'intervall',
  ...
  'einfach', 'schwer', 'suche', 'unsichtbar', 'pfeil', 'bücherregal', 'bibliothek', 'krankenhaus', 'rathaus', 'verstand', 'karaoke',
  'stolz', 'vorurteil', 'rampe', 'rampenlicht', 'gewitter', 'regen', 'präsident', 'kanzlerin', 'anwalt', 'symmetrie', 'paradigma',
  'hypothese', 'projekt', 'managerin', 'wert', 'schwert', 'brötchen', 'genießen', 'gießen', 'doktor', 'ausdruck', 'einteilung',
  'widmung', 'verschluss', 'schwein', 'affe', 'delfin', 'moment', 'annahme', 'verweigerung', 'dienstbote', 'forschung', 'mikroskop',
  'maus', 'tüte', 'einkauf', 'unterstützung', 'hilfe', 'unsicherheit', 'etage', 'stockwerk', 'lift', 'interesse', 'publikum',
  'moderator', 'brief', 'taube', 'schlagen', 'dreck', 'eifersucht', 'würfel', 'verschwinden', 'rede', 'abkürzung', 'recht', 'einigkeit',
  'schließen', 'geschlossen', 'schießen', 'freunde', 'geschwister', 'firma', 'ruhe', 'fairness', 'clever', 'intelligenz',
  'fachgebiet', 'reichtum', 'schloss', 'burg', 'thron', 'boot', 'erwachsen', 'selbstbewusst', 'kühlschrank', 'schublade', 'wahrheit',
